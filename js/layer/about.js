...
layer.about.prototype.decorate = function(parent) {
  ...
  intro.innerText =
    ...
    ' an old man. :)' +
    '\n\nHope you like the website! It\'s a single page application, which means all the routing/page switching is done' +
    ' with javascript dynamically. I built this without' +
