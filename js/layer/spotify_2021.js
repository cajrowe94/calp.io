layer.spotify_2021 = function(){
  layer.apply(this, arguments);
};
$.inherits(layer.spotify_2021, layer);

layer.spotify_2021.prototype.get_title = function(parent) {
  return '2021 Spotify stream data';
};

layer.spotify_2021.prototype.decorate = function(parent) {
  this.decorate_top_three_artists(parent);

  if (
    this.loading === false ||
    window.data.spotify_2021
  ) {
    this.decorate_top_three_artists_songs(parent);
  }
};

layer.spotify_2021.prototype.get_spotify_data = function() {
  var self = this;
  ...
  api(
    ...
    function(data) {
      self.loading = false;
      window.data.spotify_2021 = data;
      self.render();
    }
  );
};

layer.spotify_2021.prototype.format_time = function(seconds) {
  var data = {};
...
layer.spotify_2021.prototype.decorate_top_three_artists = function(parent) {
...
layer.spotify_2021.prototype.get_top_three_artists_series = function() {
  var return_data = {};
  var streams_data = $.isArray(window.data.spotify_2021) ? window.data.spotify_2021 : [];
...
layer.spotify_2021.prototype.decorate_top_three_artists_songs = function(parent) {
  var self = this;
...
layer.spotify_2021.prototype.decorate_top_songs_paper = function(artist, top_songs, place, parent) {
  var paper = new component.paper({
...
layer.spotify_2021.prototype.get_top_three_songs = function() {
  var self = this;
...
layer.spotify_2021.prototype.get_top_three_song_series = function(top_three) {
  var series = [];
